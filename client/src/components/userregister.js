...
const  Userregister=()=> {
  ...
  return (
    <div className='main h-[900px]'>
        <Navbar/>
  
        <div className='h flex flex-col gap-4 w-[30%] text-black'>
            <h1>USER DETAILS</h1>
            <span className=' flex'>
            ...
            <div id="change">
            <Link to={"/home"}><button onClick={register} className=" px-4 py-2 bg-green-400 hover:bg-green-500 rounded-lg" id="button">Register</button></Link>
            </div>
        </div>
    </div>
   );
